...
# my Efficient_Vmamba_block 
# Remeber to modify the imput shape

class EfficientVMambaBlock(nn.Module):
    """
    ResBlock-like wrapper for intermediate feature processing.
    ...
    def forward(self, x):
        # x: [B, C, H, W]
        # ----------------------------Modify the input shape here---------------------------------
        # VSSBlock originally take [B, H, W, C]
        # In case your input is [B, C, H, W], you have to transfer the shape here
